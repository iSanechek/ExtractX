...
fun Fragment.askPermissions(vararg permissions: String, callbacks: PermissionCallbacksDSL.() -> Unit) {
    ...
    if (permissionsNeeded.isNotEmpty()) {
        ...
        if (shouldShowRationalePermissions.isNotEmpty()) {
            ...
            permissionCallbacks.onShowRationale(PermissionRequest(requireActivity(), shouldShowRationalePermissions, requestCode))
            return
        }
